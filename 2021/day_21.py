...
def dirac_p2_turn( p1_pos, p1_score, p2_pos, p2_score, die, total_die_rolls ):
	...
	padding_delim = '  '
	output_padding += padding_delim
	for i in range( 0, total_die_rolls ):
		output_padding += padding_delim

	if DEBUG_2: print( output_padding + '-P2- Pos: {0} -> {1}\t\tScore: {2}'.format( old_pos, p2_pos, p2_score ) )
...
def dirac_p1_turn( p1_pos, p1_score, p2_pos, p2_score, die, total_die_rolls ):
	...
	if DEBUG_2: print( output_padding + 'P1- Pos: {0} -> {1}\t\tScore: {2}'.format( old_pos, p1_pos, p1_score ) )
