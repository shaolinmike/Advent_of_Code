...
Your puzzle answer was 4441893.
...
def parse_data( raw_data ):
	public_key_card = raw_data[ 0 ]
	public_key_door = raw_data[ 1 ]

	card = RFID_object( public_key_card )
	door = RFID_object( public_key_door )
